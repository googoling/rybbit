  ...
  try {
    ...
    if (response.ok) {
      ...
      resolvedConfig = {
        ...
        enableHeatmaps: apiConfig.enableHeatmaps ?? defaultConfig.enableHeatmaps, // CUSTOM
        heatmapSampleRate: apiConfig.heatmapSampleRate ?? defaultConfig.heatmapSampleRate, // CUSTOM
      };
    } else {
