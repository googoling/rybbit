...
import { mailboRoutes } from "./custom/mailbo/index.js"; // CUSTOM
...
async function analyticsRoutes(fastify: FastifyInstance) {
  ...
  fastify.get("/sites/:siteId/heatmap/pages", publicAnalyticsRead, getHeatmapPages); // CUSTOM
  fastify.get("/sites/:siteId/heatmap/clicks", publicAnalyticsRead, getClickHeatmap); // CUSTOM
  fastify.get("/sites/:siteId/heatmap/attention", publicAnalyticsRead, getAttentionMap); // CUSTOM
  fastify.get("/sites/:siteId/heatmap/scroll", publicAnalyticsRead, getScrollMap); // CUSTOM
  fastify.get("/sites/:siteId/heatmap/elements", publicAnalyticsRead, getRankedElements); // CUSTOM
  fastify.get("/sites/:siteId/heatmap/insights", publicAnalyticsRead, getClickInsights); // CUSTOM
  fastify.get("/sites/:siteId/heatmap/snapshot", publicAnalyticsRead, getHeatmapSnapshot); // CUSTOM
  fastify.get("/sites/:siteId/heatmap/snapshots", publicAnalyticsRead, getHeatmapSnapshots); // CUSTOM
...
async function sessionReplayRoutes(fastify: FastifyInstance) {
  ...
  fastify.post("/heatmap/record/:siteId", recordHeatmap); // CUSTOM - public tracking endpoint
  fastify.post("/heatmap/snapshot/:siteId", recordHeatmapSnapshot); // CUSTOM - public tracking endpoint
...
async function apiRoutes(fastify: FastifyInstance) {
  ...
  await fastify.register(mailboRoutes); // CUSTOM
